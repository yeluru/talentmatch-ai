...
const recruiterNavGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { title: 'Talent Search', href: '/recruiter/search', icon: Search }, // Unified hierarchical search
      { title: 'Shortlists', href: '/recruiter/shortlists', icon: ListChecks },
      // OLD (kept for rollback): { title: 'ATS Match Search', href: '/recruiter/ats-match-search', icon: Search },
      // OLD (kept for rollback): { title: 'Talent Search', href: '/recruiter/talent-search/search', icon: Search },
    ],
  },
  {
    label: 'Jobs',
