...
export function CompactTalentPoolRow({
  ...
  return (
    <div
      className="glass-panel p-3 hover-card-premium flex flex-nowrap items-center gap-4 cursor-pointer group transition-all duration-300 relative z-0 hover:z-10"
