              ...
              <div className="relative glass-card rounded-[2.5rem] p-8 shadow-xl animate-float border border-white/10">
                <div className="space-y-8">
                  <div className="flex items-center gap-6">
                    <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center shadow-lg">
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-2xl md:text-3xl font-display font-bold text-foreground mb-6">How It Works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto relative z-10">
            {steps.map((step, index) => (
              <div key={step.number} className="relative group text-center">
                ...
                <div className="relative z-10 inline-flex items-center justify-center h-16 w-16 rounded-3xl bg-white dark:bg-slate-800 shadow-xl border border-blue-100 dark:border-blue-900/30 mb-8 group-hover:scale-110 transition-transform duration-500">
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative glass-card rounded-[2.5rem] p-10 border border-white/20 shadow-2xl text-center">
                <div className="mb-8">
                  <div className="h-16 w-16 mx-auto rounded-full bg-blue-500/10 flex items-center justify-center mb-6">
