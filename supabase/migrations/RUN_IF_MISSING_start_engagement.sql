-- Run this in Supabase Dashboard > SQL Editor if you get RLS errors when starting an engagement.
-- Creates start_engagement RPC so engagement + application are created without RLS blocking.
